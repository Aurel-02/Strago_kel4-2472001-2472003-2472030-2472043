...
from dijkstra import get_dijkstra_trace
...
def tampilkan_jejak_dijkstra(trace_rows):
    print("\n========== JEJAK PERHITUNGAN DIJKSTRA ==========")
 
    if not trace_rows:
        print("Tidak ada proses Dijkstra yang dapat ditampilkan.")
        return
 
    for row in trace_rows:
        print(f"\nIterasi {row['Iterasi']}")
        print(f"Node dipilih 	: {row['Node Dipilih']}")
        print(f"Jarak node   	: {row['Jarak Node']} km")
        print(f"Node diperbarui  : {row['Node Diperbarui']}")
        print(f"Node selesai 	: {row['Node Selesai']}")
...
def main():
    ...
    dijkstra_result = get_dijkstra_trace(
        matrix,
        start_node,
        target_node,
        NODE_NAMES
    ...
    jarak = dijkstra_result["distance"]
    ...
    tampilkan_jejak_dijkstra(dijkstra_result["trace_rows"])
